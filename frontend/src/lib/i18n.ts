...
export const dictionary = {
  es: {
    ...
    tgBtnSent: '¡Enviado!',
    tgBtnError: 'Error',
    tgHelperText: `El bot enviará una tarjeta de pago interactiva al chat. Nota: Para chats privados, el receptor debe haber iniciado una conversación previamente con el bot (@LexiusPayBot). Para grupos, el bot debe estar agregado como miembro.`,
  ...
  en: {
    ...
    tgBtnSent: 'Sent!',
    tgBtnError: 'Error',
    tgHelperText: `The bot will send an interactive payment card to the specified chat. Note: For private 1-on-1 chats, the recipient must have previously started a conversation with the bot (@LexiusPayBot). For groups, the bot must be a member.`,
