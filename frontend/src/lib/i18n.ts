...
export const dictionary = {
  es: {
    ...
    tgShareTitle: 'Notificar al Comprador por Telegram',
    tgPlaceholder: '@usuario_comprador o Chat ID',
    tgBtnSend: 'Enviar Solicitud',
    tgBtnSending: 'Enviando Solicitud...',
    tgBtnSent: '¡Solicitud Enviada!',
    tgBtnError: 'Error al enviar',
    tgHelperText: `El bot enviará la solicitud de pago protegida al comprador por Telegram con las instrucciones para depositar los fondos de forma segura en Arbitrum Stylus. Nota: Para chats privados, el comprador debe haber iniciado conversación previamente con el bot (@${TELEGRAM_BOT_USERNAME}).`,
  ...
  en: {
    ...
    tgShareTitle: 'Notify Buyer via Telegram',
    tgPlaceholder: '@buyer_username or Chat ID',
    tgBtnSend: 'Send Request',
    tgBtnSending: 'Sending Request...',
    tgBtnSent: 'Request Sent!',
    tgBtnError: 'Failed to send',
    tgHelperText: `The bot will send an interactive protected payment request card to the buyer via Telegram with instructions for depositing funds safely into Arbitrum Stylus WASM. Note: For 1-on-1 chats, the buyer must have previously started a conversation with the bot (@${TELEGRAM_BOT_USERNAME}).`,
